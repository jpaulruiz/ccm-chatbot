...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      { title: "Settings — Helm HQ" },
      { name: "description", content: "Workspace, branding and team settings." },
    ],
  }),
      ...
      <Card>
        ...
        <CardContent className="pt-0">
          ...
          <Row label="Default model" hint="New agents start with this model.">
            <Input defaultValue="google/gemini-3-flash" />
          </Row>
          <Row label="Brand color" hint="Used in widget headers and email handoffs.">
            <div className="flex items-center gap-3">
              <div className="size-10 rounded-lg border border-border bg-primary" />
